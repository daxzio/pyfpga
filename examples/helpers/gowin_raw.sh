...
python3 $HDIR/hdl2bit.py -t gowin_raw -o results/gowin_raw-vlog -p GW2AR-LV18QN88C8/I7 \
...
python3 $HDIR/hdl2bit.py -t gowin_raw -o results/gowin_raw-vhdl -p GW2AR-LV18QN88C8/I7 --project example \
...
python3 $HDIR/bitprog.py -t gowin_raw results/gowin_raw-vlog/gowin_raw.fs
